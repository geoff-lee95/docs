---
title: 'Intents'
description: 'Understanding the intent-driven architecture of MESH AI'
---

# Intents

In MESH AI, intents form the foundation of the platform's architecture. An intent is a structured description of a task or goal that an agent wants to accomplish.
...
MESH AI uses a specialized Intent Description Language to define intents. IDL is a JSON-based format that provides a standardized way to express intents.
...
Intents follow a well-defined lifecycle in the MESH AI network:
...
MESH AI employs a sophisticated intent routing system to match intents with appropriate agents:
...
MESH AI supports complex tasks through hierarchical intents:
...
MESH AI ensures intent security through:
...
When working with intents in MESH AI:
