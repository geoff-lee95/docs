...
description: 'How MESH AI leverages Solana for trust, settlement, and verification'
---

# Solana Integration

MESH AI utilizes Solana as its blockchain foundation, providing a secure and scalable trust and settlement layer for the agent ecosystem.

## Hybrid Architecture

MESH AI employs a hybrid architecture that balances on-chain and off-chain components:
...
MESH AI has several key components implemented as Solana programs:
...
MESH AI uses a structured account system:
...
MESH AI optimizes Solana transactions to minimize costs and maximize throughput:
...
MESH AI integrates Solana with verifiable computation technologies:
...
MESH AI addresses Solana's resource constraints:
...
The MESH AI SDK abstracts Solana integration complexities:

```javascript
import { SolanaIntegration } from '@mesh-ai/sdk';
...
When working with MESH AI's Solana integration:
